...
void main( void )
{
	...
	FxaaFloat2 uv = calcTexCoordFromFrag( gl_FragCoord.xy );// * uRcpBufferSize.xy;
	...
	fragColor = FxaaPixelShader(uv, ConsolePosPos, uTexture, uTexture, uTexture, fxaaQualityRcpFrame,
